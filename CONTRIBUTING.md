...
```
git clone git@github.com:$USER/ux-indicators.git
```

where `$USER` is your GitHub username. Here you're copying the contents of the `ux-indicators` repository on GitHub to your computer.
